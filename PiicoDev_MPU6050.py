...
class PiicoDev_MPU6050(object):     
    ...
    def read_accel_data(self, g = False):         
        ...
        x = (accel_data['x']-2050) / 16384.00
        y = (accel_data['y']-77) / 16384.00
        z = (accel_data['z']-1947) / 16384.00
    ...
    def read_gyro_data(self):
        ...
        x = (gyro_data['x']+270) / 131.07
        y = (gyro_data['y']-351) / 131.07
        z = (gyro_data['z']+136) / 131.07
